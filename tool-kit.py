...
@@@@@@@@@@@@@ @@@@@@@@@\__@_/@@@@@
 @@@@@@@@@@@@@@@/,/,/./'/_|.\'\,\"""")
print(verde+"BEM VINDO AO TOOL-KIT BY MAELOR404")
time.sleep(1)
print("Team 404")
...
time.sleep(2)
os.system("clear")
print(vermelho+"Aqui irei te mostrar ferramentas comuns do hacking e oque elas fazem")
time.sleep(0.8)
...
print("[11] Sair")
time.sleep(1)
opçao = int(input(verde+"Escolha uma das opçoes acima: "))
...
if opçao == 1:
 ...
 print(vermelho+"Essa nao é uma opção disponivel, reiniciando script")
 time.sleep(2)
 os.system("python tool-kit.py")
